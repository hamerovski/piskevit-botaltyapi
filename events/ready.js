...
var oyun = [
        ...
        "/korona | Korona istatistiklerini gör!",
        "/tarot | Tarot kartı çek!",
        "/bitcoin | BTC fiyatlarını listeler!",
        "/napim | Lafı yapıştır! ",
        "/özlüsöz | Efsane bir söz gönder!",
        "/fal | Falında ne var?",
        "/aşkölçer | Sana ne kadar aşık?"
    ...
    setInterval(function() {
        ...
        client.user.setActivity(oyun[random], "https://twitch.tv/." );
